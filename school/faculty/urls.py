...
urlpatterns = [
    ...
    path("timetable/<int:entry_id>/edit/", views.timetable_edit, name="timetable_edit"),
    path("timetable/<int:entry_id>/delete/", views.timetable_delete, name="timetable_delete"),
